-- Add Kolkata and Hyderabad to physical interview city options
...
COMMENT ON COLUMN public.candidates.physical_interview_city IS
  'Interview city when candidate is on physical interview track (Delhi, Bengaluru, Mumbai, Pune, Kolkata, or Hyderabad).';
...
COMMENT ON COLUMN public.project_candidates.physical_interview_city IS
  'Interview city when project candidate is on physical interview track (Delhi, Bengaluru, Mumbai, Pune, Kolkata, or Hyderabad).';
