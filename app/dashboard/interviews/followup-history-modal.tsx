...
export function FollowupHistoryModal({
  ...
  const th = "border-b border-border px-3 py-2 text-left text-xs font-semibold uppercase tracking-wide text-muted";
  const td = "border-b border-border px-3 py-2 text-sm text-foreground align-top";
      ...
      >
        <div className="flex items-start justify-between border-b border-border-subtle p-5">
          <div>
            ...
            <p className="text-sm text-muted">{candidateLabel}</p>
          </div>
          <button
            type="button"
